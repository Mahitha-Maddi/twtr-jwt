...
mongo_client = MongoClient("mongodb+srv://Mahitha-Maddi:Mahitha%4042@cluster0.1z0g8.mongodb.net/tweets?retryWrites=true&w=majority")
...
def atlas_connect():
    ...
    # Python
    client = pymongo.MongoClient("mongodb+srv://Mahitha-Maddi:Mahitha%4042@cluster0.1z0g8.mongodb.net/tweets?retryWrites=true&w=majority")
    db = client.test
